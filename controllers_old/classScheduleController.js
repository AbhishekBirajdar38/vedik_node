...
export const editClassSchedule = async (req, res) => {
  try {
    const {
      schedule_id,
      day_name,
...
export const updateTopic = async (req, res) => {
  try {
    const { id, topic_name, topic_description, level, category, is_active } =
      req.body;
...
export const getClassSlotsByDate = async (req, res) => {
  try {
...
export const updateClassTopicByDate = async (req, res) => {
  try {
...
//       `
//     SELECT
//   TO_CHAR(cs.class_date, 'YYYY-MM-DD') AS class_date, -- ✅ STRING, NO TZ
//   cs.day_name,

//   MIN(cs.slot_range) AS start_time,
//   MAX(cs.slot_range) AS end_time,

//   MAX(cs.topic) FILTER (WHERE cs.topic IS NOT NULL) AS topic,
...
export const getStudentClassesFromToken = async (req, res) => {
  try {
...
export const updateClassLinkBySlotId = async (req, res) => {
  try {
...
export const markAttendanceOnJoin = async (req, res) => {
  try {
    const userCode = req.user?.user_code;
    const { slot_id } = req.body;
...
export const getMyAttendanceFromToken = async (req, res) => {
  try {
    const userCode = req.user?.user_code;
